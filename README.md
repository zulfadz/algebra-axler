This is a collection of notes on the book "Linear Algerba Done Right" by Axler. These notes contain solutions to some of the exercises. The template is obtained from user maksimim.
